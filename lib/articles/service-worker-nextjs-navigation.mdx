export const meta = {
  ...
  readTime: "~10 min",
  cover:
    "https://images.unsplash.com/photo-1760001869138-94d0d1cc87d7?q=80&w=1600&auto=format&fit=crop",
  coverAlt: "Métro jaune flou en mouvement à l'arrêt en station",
  coverCredit: "Nico Knaack",
  coverCreditUrl: "",
};
...
Le site utilisait [Lenis](https://lenis.darkroom.engineering/) pour le smooth scroll. L'instance était créée une seule fois au mount du layout :
...
<CodeBlock lang="TypeScript">{`// ✅ APRÈS — scroll reset au niveau navigateur, immunisé React
useEffect(() => {
  const scrollToTop = () => {
